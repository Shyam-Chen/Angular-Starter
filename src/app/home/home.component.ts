        ...
        <svg width="100%" height="100%" viewBox="0 0 402 328" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet">
          ...
          <g fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(8 160)">
              <use fill="#000" filter="url(#sza-c)" xlink:href="#sza-d"></use>
              <use fill="#42A5F5" xlink:href="#sza-d"></use>
              <rect fill="#FFF" x="30" y="14" width="57" height="10" rx="2.662"></rect>
              <ellipse fill="#DDF6F9" cx="16" cy="20" rx="5" ry="5"></ellipse>
            </g>
            <g transform="translate(48 113)">
              <use fill="#000" filter="url(#sza-e)" xlink:href="#sza-f"></use>
              <use fill="#42A5F5" xlink:href="#sza-f"></use>
              <rect fill="#FFF" x="33" y="14" width="57" height="10" rx="2.662"></rect>
              <ellipse fill="#DDF6F9" cx="14" cy="19" rx="5" ry="5"></ellipse>
            </g>
            <g transform="translate(147 88)">
              <use fill="#000" filter="url(#sza-g)" xlink:href="#sza-h"></use>
              <use fill="#42A5F5" xlink:href="#sza-h"></use>
              <circle fill="#FFF" cx="9" cy="8" r="6"></circle>
            </g>
            <g transform="translate(12 55)">
              <use fill="#000" filter="url(#sza-i)" xlink:href="#sza-j"></use>
      ...
      <div class="oma-promo">
        <svg height="100%" viewBox="0 0 402 251" width="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet">
          <defs>
            ...
            <rect id="fac-b" height="180" rx="4" width="345"></rect>
            <mask id="fac-e" fill="#fff" height="180" width="345" x="0" y="0">
              <use xlink:href="#fac-b"></use>
            </mask>
            <linearGradient id="fac-f" x1="0%" x2="0%" y1="31.325%" y2="0%">
              <stop offset="0%" stop-color="#FFF" stop-opacity=".739"></stop>
              <stop offset="100%" stop-color="#FFF" stop-opacity="0"></stop>
            </linearGradient>
            <linearGradient id="fac-g" x1="14.641%" x2="77.092%" y1="0%" y2="79.931%">
            ...
            <mask id="fac-i" fill="#fff" height="116.116" width="117.428" x="0" y="0">
              <use xlink:href="#fac-c"></use>
            </mask>
          </defs>
        ...
        <svg height="100%" viewBox="0 0 372 271" width="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet">
          <defs>
            ...
            <mask id="opt-y" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-a"></use>
            </mask>
            <path id="opt-b" d="M37 38h39v39H37z"></path>
            <mask id="opt-z" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-b"></use>
            </mask>
            <path id="opt-c" d="M0 0h39v39H0z"></path>
            <mask id="opt-A" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-c"></use>
            </mask>
            <path id="opt-d" d="M37 0h39v39H37z"></path>
            <mask id="opt-B" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-d"></use>
            </mask>
            <path id="opt-e" d="M75 38h39v39H75z"></path>
            <mask id="opt-C" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-e"></use>
            </mask>
            <path id="opt-f" d="M38 38h39v39H38z"></path>
            <mask id="opt-D" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-f"></use>
            </mask>
            <path id="opt-g" d="M0 38h39v39H0z"></path>
            <mask id="opt-E" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-g"></use>
            </mask>
            <path id="opt-h" d="M0 0h39v39H0z"></path>
            <mask id="opt-F" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-h"></use>
            </mask>
            <path id="opt-i" d="M75 38h39v39H75z"></path>
            <mask id="opt-G" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-i"></use>
            </mask>
            <path id="opt-j" d="M38 38h39v39H38z"></path>
            <mask id="opt-H" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-j"></use>
            </mask>
            <path id="opt-k" d="M38 0h39v39H38z"></path>
            <mask id="opt-I" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-k"></use>
            </mask>
            <path id="opt-l" d="M0 0h39v39H0z"></path>
            <mask id="opt-J" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-l"></use>
            </mask>
            <path id="opt-m" d="M0 74h39v39H0z"></path>
            <mask id="opt-K" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-m"></use>
            </mask>
            <path id="opt-n" d="M38 37h39v39H38z"></path>
            <mask id="opt-L" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-n"></use>
            </mask>
            <path id="opt-o" d="M0 37h39v39H0z"></path>
            <mask id="opt-M" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-o"></use>
            </mask>
            <path id="opt-p" d="M0 0h39v39H0z"></path>
            <mask id="opt-N" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-p"></use>
            </mask>
            <path id="opt-q" d="M75 38h39v39H75z"></path>
            <mask id="opt-O" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-q"></use>
            </mask>
            <path id="opt-r" d="M38 38h39v39H38z"></path>
            <mask id="opt-P" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-r"></use>
            </mask>
            <path id="opt-s" d="M0 38h39v39H0z"></path>
            <mask id="opt-Q" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-s"></use>
            </mask>
            <path id="opt-t" d="M38 0h39v39H38z"></path>
            <mask id="opt-R" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-t"></use>
            </mask>
            <path id="opt-u" d="M37 75h39v39H37z"></path>
            <mask id="opt-S" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-u"></use>
            </mask>
            <path id="opt-v" d="M37 37h39v39H37z"></path>
            <mask id="opt-T" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-v"></use>
            </mask>
            <path id="opt-w" d="M37 0h39v39H37z"></path>
            <mask id="opt-U" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-w"></use>
            </mask>
            <path id="opt-x" d="M0 0h39v39H0z"></path>
            <mask id="opt-V" fill="#fff" height="39" width="39" x="0" y="0">
              <use xlink:href="#opt-x"></use>
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd" stroke="#1E88E5" stroke-width="2.662">
            <g fill="#BBDEFB" transform="translate(7 175)">
              <use xlink:href="#opt-a" mask="url(#opt-y)"></use>
              <use xlink:href="#opt-b" mask="url(#opt-z)"></use>
              <use xlink:href="#opt-c" mask="url(#opt-A)"></use>
              <use xlink:href="#opt-d" mask="url(#opt-B)"></use>
            </g>
            <g fill="#0D47A1" transform="translate(81 175)">
              <use xlink:href="#opt-e" mask="url(#opt-C)"></use>
              <use xlink:href="#opt-f" mask="url(#opt-D)"></use>
              <use xlink:href="#opt-g" mask="url(#opt-E)"></use>
              <use xlink:href="#opt-h" mask="url(#opt-F)"></use>
            </g>
            <g fill="#BBDEFB" transform="translate(81 63)">
              <use xlink:href="#opt-i" mask="url(#opt-G)"></use>
              <use xlink:href="#opt-j" mask="url(#opt-H)"></use>
              <use xlink:href="#opt-k" mask="url(#opt-I)"></use>
              <use xlink:href="#opt-l" mask="url(#opt-J)"></use>
            </g>
            <g fill="#BBDEFB" transform="translate(237 101)">
              <use xlink:href="#opt-m" mask="url(#opt-K)"></use>
              <use xlink:href="#opt-n" mask="url(#opt-L)"></use>
              <use xlink:href="#opt-o" mask="url(#opt-M)"></use>
              <use xlink:href="#opt-p" mask="url(#opt-N)"></use>
            </g>
            <g fill="#42A5F5" transform="translate(237 175)">
              <use xlink:href="#opt-q" mask="url(#opt-O)"></use>
              <use xlink:href="#opt-r" mask="url(#opt-P)"></use>
              <use xlink:href="#opt-s" mask="url(#opt-Q)"></use>
              <use xlink:href="#opt-t" mask="url(#opt-R)"></use>
            </g>
            <g fill="#0D47A1" transform="translate(278 13)">
              <use xlink:href="#opt-u" mask="url(#opt-S)"></use>
              <use xlink:href="#opt-v" mask="url(#opt-T)"></use>
              <use xlink:href="#opt-w" mask="url(#opt-U)"></use>
              <use xlink:href="#opt-x" mask="url(#opt-V)"></use>
            </g>
          </g>
        </svg>
      </div>
